...
new_dataset = []
with open('matched/matched_claim_ibm_emnlp_test.txt', 'r') as f:
    for line in f:
        line = line.strip()
        warrant_pool = []
...
#        print(line)
        ...
        rand_warrant = random.sample(warrant_pool, 1)[0]
        new_dataset += [(line, rand_warrant)]
fi = open('matched/matched_warrants_ibm_emnlp_test.txt', 'w')
